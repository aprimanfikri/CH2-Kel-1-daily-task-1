...
const registerYear = (data) => {
  // tempat penampungan hasil
  let result = [];
  // looping data dalam array
  for (let i = 0; i < data.length; i++) {
    // memeriksa apakah user mempunyai tahun register 2014 - 2018 menggunakan slice agar mendapatkan potongan karakter dari indeks 0 hingga indeks 3
    if (
      parseInt(data[i].registered.slice(0, 4)) >= 2014 &&
      parseInt(data[i].registered.slice(0, 4)) <= 2018
    ) {
  ...
  // print total user dengan tahun 2014 - 2018
  console.log(
    `Jumlah user dengan tahun register 2014 - 2018 adalah: ${result.length}`
  );
  console.log("============================================================");
...
// panggil fungsi registerYear dan print hasilnya di konsol
console.log(registerYear(users));
