...
const genderOrEyeColor = (data) => {
  // tempat penampungan hasil
  let result = [];
  // looping data dalam array
  for (let i = 0; i < data.length; i++) {
    // memeriksa apakah gender female ATAU eye color brown
  ...
  // print total user dengan gender female ATAU eye color brown
  console.log(
    `Jumlah user yang mempunyai gender female ATAU eye color brown : ${result.length}`
  );
  console.log("==========================================");
...
// panggil fungsi genderOrEyeColor dan print hasilnya di konsol
console.log(genderOrEyeColor(users));
