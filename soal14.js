...
const companyEmail = (data) => {
  ...
  for (let i = 0; i < data.length; i++) {
    // mengganti company dengan binar
    data[i].company = "binar";
    // Mengubah format email
    data[i].email = data[i].email.split("@")[0] + "@binar.org";
  }
  return data;
};
// panggil fungsi companyEmail dan print hasilnya di konsol
console.log(companyEmail(users));
