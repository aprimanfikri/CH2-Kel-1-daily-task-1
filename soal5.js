...
const eyeColor = (data) => {
  ...
  for (let i = 0; i < data.length; i++) {
    // memeriksa apakah eye color blue
  ...
  // print total user dengan eyeColor blue
  console.log(
    `Jumlah user yang mempunyai eye color blue adalah : ${result.length}`
  );
  console.log("==========================================");
...
// panggil fungsi eyeColor dan print hasilnya di konsol
console.log(eyeColor(users));
