...
const checkGender = (data) => {
  ...
  for (let i = 0; i < data.length; i++) {
    // memeriksa apakah gender user adalah female
    if (data[i].gender === "female") {
      // jika iya maka push data kedalam result
      result.push(data[i]);
    }
  }
  // print total user dengan gender female
  console.log(`Jumlah user dengan gender female adalah : ${result.length}`);
  console.log("==========================================");

  return result;
};

// panggil fungsi checkGender dan print hasilnya di konsol
